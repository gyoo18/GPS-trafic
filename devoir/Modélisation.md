...
| NavigateurManuel          | Variante du navigateur qui agit comme interface entre l'utilisateur et l'intersection                                                     |                                                                                                                                                                           | `miseÀJour()` : exécute l'action que l'utilisateur a choisie.                                                                                                                                                                                                                                                                                                                                            |
